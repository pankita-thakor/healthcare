    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="text-sm text-muted-foreground">Track Stripe payments, disputes, and payout visibility.</CardContent>
        </Card>
        <Card>
          <CardHeader><CardTitle>System monitoring</CardTitle></CardHeader>
          <CardContent className="text-sm text-muted-foreground">Audit logs, API uptime, realtime health, and incident alerts.</CardContent>
        </Card>
      </div>
    </div>
  );
