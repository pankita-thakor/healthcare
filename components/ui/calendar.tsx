  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4",
        caption: "flex justify-between items-center pt-1 pb-2 px-1",
        caption_label: "text-sm font-semibold",
        nav: "flex items-center gap-1",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-8 w-8 bg-transparent p-0 rounded-lg opacity-70 hover:opacity-100 border-border/40 shrink-0"
        ),
        nav_button_previous: "",
        nav_button_next: "",
        table: "w-full border-collapse",
        head_row: "grid grid-cols-7 w-full",
        head_cell: "text-muted-foreground flex items-center justify-center font-medium text-xs uppercase",
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-medium rounded-lg aria-selected:opacity-100 w-full"
        ),
